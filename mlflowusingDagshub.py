...
import dagshub
dagshub.init(repo_owner='sg296858', repo_name='MLFLOW', mlflow=True)


wine=load_wine()

mlflow.set_tracking_uri("https://dagshub.com/sg296858/MLFLOW.mlflow")
...
#set experiment name
mlflow.set_experiment("MLOps Experiment 3")
